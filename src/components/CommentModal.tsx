...
const CommentModal: React.FC<CommentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white/10 border border-white/20 rounded-2xl p-6 w-full max-w-md backdrop-blur-md relative">
        <button
          onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          <textarea
            className="w-full p-2 border rounded bg-transparent text-white border-white/30 focus:border-blue-400 focus:ring-0"
            rows={4}
            value={comment}
